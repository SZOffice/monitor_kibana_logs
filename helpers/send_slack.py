...
def upload_slack(token, channel, title, msg, files):
    ...
    textmod = {
        ...
        #'filename': 'a.png',
        #'filetype': 'png',
        'icon_url': 'https://images.contentstack.io/v3/assets/bltefdd0b53724fa2ce/blt953f74da22884857/5d02ca0a4234d7fc42c505bf/elastic-logo-reverse.svg',
        'username': 'Monitor DB RC Error'
    }
